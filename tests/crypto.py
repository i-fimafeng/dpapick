...
class CryptoTest(unittest.TestCase):
    def setUp(self):
        ...
        self.expected = binascii.unhexlify("732f73394364c930ba285063e5ff1ae49ebb3332")
        self.hashpwd = binascii.unhexlify("8fd090d6121b0f67ebb58bce562bf02b3f1e6bb4")

    def test_CryptSessionKeyXP(self):
        m = binascii.unhexlify("f1cd9c3915428d12c0e9bf5ac0c44dda"
             "647e6e387118c09eb00a294e485a3f6e"
             "fe47f16686ad5f60fbd740164de87711"
             "6eb70d35445b22ddebdb02b0d55ee613")
        n = binascii.unhexlify("55d9d46709e463db53c783ec1edd69dc")
        h = crypto.CryptoAlgo(0x8004)
        r = binascii.unhexlify("397ec5c4dc5d5733b7dadd94178f827951b5ea66")
    ...
    def test_CryptSessionKeyXPEntropy(self):
        m = binascii.unhexlify("d0c624a61e4080ac28ec07f33466581e"
             "c04980f26953aa940258dc4ced7fd545"
             "251208d88d6bac5c64b5cd69b4e21400"
             "93174f51ab07f0f5fb7a45462a2c00e4")
        n = binascii.unhexlify("0c1e54f10d3ac713ef4c19dbc440e4a7")
        h = crypto.CryptoAlgo(0x8004)
        e = binascii.unhexlify("746f746f313233")
        r = binascii.unhexlify("9e0ee9a096bcd43c315a211dc7fdb1fd1a01cbec")
    ...
    def test_CryptSessionKeyXPStrong(self):
        m = binascii.unhexlify("f1cd9c3915428d12c0e9bf5ac0c44dda"
             ...
             "fe47f16686ad5f60fbd740164de87711"
             "6eb70d35445b22ddebdb02b0d55ee613")
        n = binascii.unhexlify("38d39c66910558b6a4e961b5de40e849")
        h = crypto.CryptoAlgo(0x8004)
        s = binascii.unhexlify("010000002f44b69f6a6280499c85d238"
             ...
             "ae7701754baf9f844c9f1cbddf818a9f")
        r = binascii.unhexlify("be5c65c109be3c7fd4787df81e923b596f635d0f")
    ...
    def test_CryptSessionKeyXPEntropyStrong(self):
        m = binascii.unhexlify("d0c624a61e4080ac28ec07f33466581e"
             ...
             "251208d88d6bac5c64b5cd69b4e21400"
             "93174f51ab07f0f5fb7a45462a2c00e4")
        n = binascii.unhexlify("bde7c0f3b1d5def7cbb6669c2c2b361c")
        h = crypto.CryptoAlgo(0x8004)
        e = binascii.unhexlify("746f746f313233")
        s = binascii.unhexlify("0100000018fa1d263223e54993d9388d2"
             ...
             "1bbbf")
        r = binascii.unhexlify("5906ca660b04e0c1bce743ebe5b21aa9e79acc1f")
    ...
    def test_CryptSessionKeyWin81(self):
        m = binascii.unhexlify("c942b584a88a36f3ce8abe61a62d4036"
             "49dfdd8fd9b256a4a7ff64bfe2b60df8"
             "cb563be71d0d65f8be03ebdd76b4dba1"
             "68a9e3883fee758d2c4aeef040571cc2")
        n = binascii.unhexlify(
            "9798683005ff678f507036b44bcbbcfe150115346bf67bd75ad73b42ce6331bf")
        h = crypto.CryptoAlgo(0x800e)
        r = binascii.unhexlify("d9a268bcc45620cd4602f17e7b1c0b28"
             "671a34f34ffb09c752f822c11464bea3"
             "4d3090ba78ece4703f190d4a0f22cd1b"
             "4cf224685eb317c6617f12368fd5197e")
    ...
    def test_CryptSessionKeyWin81Entropy(self):
        ...
        h = crypto.CryptoAlgo(0x800e)
        e = binascii.unhexlify("5570546f41707000")
        r = binascii.unhexlify("8fc15ae914a579f22e74547eb4276032"
             "76dee6f2cf72705dd08c473615f2e8e2"
             "3281cee2037aefd5ba0392dc9866a948"
             "feb08a4752c035f2723dd37063be9a13")
    ...
    def test_CryptSessionKeyWin81Strong(self):
        m = binascii.unhexlify("c942b584a88a36f3ce8abe61a62d4036"
             ...
             "68a9e3883fee758d2c4aeef040571cc2")
        n = binascii.unhexlify(
            "40da71bec41e2cf971d270977099e1d34030f0875de802967769f7b4906cbc95")
        h = crypto.CryptoAlgo(0x800e)
        s = binascii.unhexlify("010000003fb376ba974b974e96037865"
             ...
             "e1467028df028177bda3c9c34057")
        r = binascii.unhexlify("45fb9275a0e852ed4b9f2e34ec6100bb"
             "2d3bd5225da37bccb73bfb89b4073dc2"
             "15840c8beeb728201ab69a41945c944c"
             "f6ae645d2e69d00b752ca1552b42ed3d")
    ...
    def test_CryptSessionKeyWin81EntropyStrong(self):
        m = binascii.unhexlify("c942b584a88a36f3ce8abe61a62d4036"
             ...
             "68a9e3883fee758d2c4aeef040571cc2")
        n = binascii.unhexlify(
            "dc2539884092c76194a57bbf090e94dcec850a23f03afcef723de96b6b1a4638")
        h = crypto.CryptoAlgo(0x800e)
        e = binascii.unhexlify("5570546f41707000")
        s = binascii.unhexlify("010000003fb376ba974b974e96037865"
             ...
             "d747986bfd422553f30c8fb1265e1365")
        r = binascii.unhexlify("3c4236133cc43d416ed650106e0f980d"
             "e4c58e5db4513ea0605207b0835ac69c"
             "2c95f3b5b26511c44543a996b3909526"
             "89843a20dbbaa209e6440b74ff02c49c")
    ...
    def test_CryptDeriveKeyWin8(self):
        h = binascii.unhexlify("d9a268bcc45620cd4602f17e7b1c0b28"
             "671a34f34ffb09c752f822c11464bea3"
             "4d3090ba78ece4703f190d4a0f22cd1b"
             "4cf224685eb317c6617f12368fd5197e")
    ...
    def test_CryptDeriveKeyXP(self):
        h = binascii.unhexlify("9e0ee9a096bcd43c315a211dc7fdb1fd1a01cbec")
        c = crypto.CryptoAlgo(0x6610)
        r = binascii.unhexlify("e41a0d8b93243370b3722699588a83b2"
    ...
    def test_decrypt_lsa_key_nt5(self):
        lsakey = binascii.unhexlify("010000000100000000000000060677c4"
                  "63ced8d548dc2c528f2a64a5a4427907"
                  "5941537344cb7231c657f294ee4c5df0"
                  "e57268683de207cba0338cf0ea6b8e51"
                  "54a2ac6b219e2099ece22650")
        syskey = binascii.unhexlify("35bc7242385ed971867e722369bd8db4")
        r = binascii.unhexlify("b150b4b4d14976cb9709fd3c8e001eab")
    ...
    def test_decrypt_lsa_key_nt6(self):
        lsakey = binascii.unhexlify("00000001ecffe17b2a997440aa939adb"
        ...
        syskey = binascii.unhexlify("9acd05908157e45449e2ee795a9cc87e")
    ...
    def test_SystemFunction005(self):
        secret = binascii.unhexlify("71b13f003a84728dda93ff24240e21fd"
                  "19f93dcccf7c08557e86fa320dc88199"
                  "306732c9f382719a856d4fad4182edd4"
                  "02b88075b64ddf6f")
        key = binascii.unhexlify("b150b4b4d14976cb9709fd3c8e001eab")
        r = binascii.unhexlify(("01 00 00 00 AC F4 A1 4D 92 D2 E2 04 87 BA 8E 6B"
             "69 E0 D2 3C DE 31 98 0B 42 D7 03 64 16 61 20 50"
             "EB C1 E3 77 9C 7F D5 5F 14 A8 92 F4").replace(" ", ""))

        self.assertEquals(crypto.SystemFunction005(secret, key), r)

    def test_decrypt_lsa_secret(self):
        secret=binascii.unhexlify("00000001b31b971b40ab9c1ba577d333"
                ...
                "fe1f4f92d276aff94e29a685")
        key = binascii.unhexlify(
            "c6afbd790aa01079860362face32818b155facf4666a0e061b91597c46c9d1a8")
        r = binascii.unhexlify(("01 00 00 00 EB F6 82 84 52 F6 CA 25 BA 36 2F CD"
             "6C 76 36 88 70 70 87 CD 1C 14 65 17 23 BF EB 3A"
             "0E 96 25 31 36 8A DF 95 44 DE D9 78").replace(" ", ""))
    ...
    def test_pbkdf2_1round_sha1(self):
        ...
        i = 1
        r = binascii.unhexlify("b49f149f5dca24e46025fcc2fb8af8a6a19c849c7b61fcc5533c841f6eb10d8b")
    ...
    def test_pbkdf2_4000round_sha1(self):
        ...
        i = 4000
        r = binascii.unhexlify("0cb271e155eb6fd2f9c50e1c941a248d4a1d8b1cb765e0cdb8f80e144d3dfb03")
        self.assertEquals(crypto.pbkdf2(p, s, len(r), i), r)

    def test_pbkdf2_5600round_sha512(self):
        # win7
        p = binascii.unhexlify("84e40ab5bab2c5a2965fd185d60cf92fe2c1c9d2")
        s = binascii.unhexlify("1f63ff38751365ec54748b13d962698e")
        i = 5600
        r = binascii.unhexlify("38d34e6a81f8d5f650403d01407e3127"
             "f987f986328ed9c1aacd527811dd53ac"
             "5a7b8d298e37e377daa03a3ee209e638")
    ...
    def test_dataDecrypt_aes256_sha512(self):
        r = binascii.unhexlify("ac23e4d5efcb8979f05fbcb275832a8d"
        ...
        e = binascii.unhexlify("84e40ab5bab2c5a2965fd185d60cf92fe2c1c9d2")
        iv = binascii.unhexlify("1f63ff38751365ec54748b13d962698e")
        c = binascii.unhexlify("d23ad4bb1e254c67e2ff2902de8683b3"
             ...
             "1861c37760c9d9581662adb67f85255e")
    ...
    def test_dataDecrypt_3des_sha1(self):
        r = binascii.unhexlify("95bb351da2ee8c4463c5092a931feba5"
             "613f7bbf1570ecdefd887d5bae9dc18f"
             "a95724c1976c22012fae9cdbf6f70c4a"
             "aab721b9a87e17d725d9dd110f933977"
             "7df1b807c90af31a")
        e = binascii.unhexlify("3fe9c8cffc26443a41ec4a54daf11be86bec0ecb")
        iv = binascii.unhexlify("d43b01cc0590035e567e07b44b6ccead")
        c = binascii.unhexlify("a2dec8f74d35c7c8de819041309ea0da"
    ...
    def test_DPAPIHmac_sha512(self):
        pwdhash = binascii.unhexlify("84e40ab5bab2c5a2965fd185d60cf92fe2c1c9d2")
        hmacSalt = binascii.unhexlify("d23ad4bb1e254c67e2ff2902de8683b3")
        value = binascii.unhexlify("63dd99a8e4dc85330db0996aedd2a270"
                 "6405201ed74831e084f3b18fc5fdd209"
                 "497a2f95c2a4004e54ec731e045d9d38"
                 "1861c37760c9d9581662adb67f85255e")
        result = binascii.unhexlify("c5214e216690a6faec7da6e8e04a2d5d"
                  "1dabc1a20796811e7bc6f8146893166c"
                  "1cc9715bf0021c300cf616fa5a763a55"
                  "42a93ac3c58c42c5c54ab94d9186864f")

        self.assertEquals(crypto.DPAPIHmac(crypto.CryptoAlgo(0x800e), pwdhash, hmacSalt, value), result)

    def test_DPAPIHmac_sha1(self):
        pwdhash = binascii.unhexlify("3fe9c8cffc26443a41ec4a54daf11be86bec0ecb")
        hmacSalt = binascii.unhexlify("adc26f78a93e28e2b37bac0b4719011a")
        value = binascii.unhexlify("ba03b9f6bbdad54015d16009ff29d7be"
                 "d19b821cdb735236feeb4be82b4e8a3d"
                 "211cc28cd79c56f1846afd85fe2c040e"
                 "aa0b997aaec19b88efd945b3303ca1e5")
        result = binascii.unhexlify(
            "8bcd1e26420dca0ffb36d78387bb7ac755591c36")
